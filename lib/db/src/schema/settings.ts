...
export const settingsTable = pgTable("settings", {
  ...
  defaultHourlyRate: numeric("default_hourly_rate", { precision: 10, scale: 2 })
    .notNull()
    .default("65"),
  defaultSetupRate: numeric("default_setup_rate", { precision: 10, scale: 2 })
    .notNull()
    .default("65"),
  defaultMarginPercentage: numeric("default_margin_percentage", {
    precision: 5,
    scale: 2,
  })
    .notNull()
  ...
  termsAndConditions: text("terms_and_conditions")
    .notNull()
    .default(
      "All prices quoted are exclusive of VAT unless stated. Prices are valid for the period stated on the quote. Orders are accepted subject to these terms and conditions.",
    ),
