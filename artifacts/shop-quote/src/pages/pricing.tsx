...
const CHECK = (
  <span style={{ color: BLUE, fontWeight: 700, marginRight: 8, fontSize: 13 }}>
    ✓
  </span>
);
      ...
      <main style={{ padding: "80px 3rem" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            >
              Early-access pricing for the first cohort of machine shops. This
              is not the permanent price.
            </p>
          </div>
          ...
          >
            ...
            <div
              style={{
                ...
                padding: "40px 36px",
                boxShadow: `0 6px 28px ${BLUE_GLOW}`,
              }}
            >
              <div
                style={{
          ...
          >
            ...
            >
              <strong style={{ color: "#374151" }}>
                This is beta founder pricing.
              </strong>{" "}
              Prices will increase at general release. Founding members keep
              their original licence terms permanently.
            </p>
          </div>
          ...
          >
            {[
              ...
              {
                q: "Is this really the final price?",
                a: "No. Beta founder pricing will not be available after general release. Early adopters lock in their rate permanently.",
              },
              {
                q: "What happens after 12 payments?",
                a: "The monthly licence converts to lifetime access automatically. No further charges, ever.",
              },
            ].map(({ q, a }) => (
              <div
                key={q}
