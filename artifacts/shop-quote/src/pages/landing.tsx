    ...
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "linear-gradient(135deg, rgba(5,10,20,0.72) 0%, rgba(5,10,20,0.50) 50%, rgba(5,10,20,0.72) 100%)",
        }}
      />
    </div>
  );
...
export function LandingPage() {
  ...
  return (
    <div style={{ background: "#ffffff", color: "#111827", fontFamily: "'Inter', system-ui, sans-serif", minHeight: "100vh" }}>
          ...
          <div className="landing-header-links">
            {[
              ...
              <a
                key={label}
                href={href}
                style={{ fontSize: 13, fontWeight: 500, color: scrolled ? "#374151" : "rgba(255,255,255,0.75)", letterSpacing: "0.04em", textDecoration: "none", transition: "color 0.15s" }}
              >
                {label}
              </a>
            ))}
      ...
      <section style={{ position: "relative", height: "100svh", minHeight: 480, overflow: "hidden" }}>
        ...
        >
          <div
            ...
            style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.28em", color: BLUE, textTransform: "uppercase", marginBottom: 20 }}
          >
          ...
          >
            Professional milling and turning quotes in minutes. No spreadsheets, no guesswork.
          </p>

          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center", pointerEvents: "auto", padding: "0 1rem" }}>
            <Link href="/dashboard">
              <button
                style={{
                  padding: "15px 32px",
        ...
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 120, zIndex: 25, background: "linear-gradient(to bottom, transparent, #ffffff)" }} />
      </section>

      {/* FEATURE STRIP */}
      <section id="features" ref={featuresRef} className="landing-section-pad" style={{ padding: "80px 3rem 64px", background: "#ffffff" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.22em", color: BLUE, textTransform: "uppercase", marginBottom: 14 }}>
              BUILT FOR THE WORKSHOP
            </div>
            <h2 style={{ fontWeight: 800, fontSize: "clamp(1.6rem, 3vw, 2.6rem)", letterSpacing: "-0.025em", color: "#111827", marginBottom: 14 }}>
              Engineered for small machine shops
            </h2>
            <p style={{ color: "#6b7280", maxWidth: 460, margin: "0 auto", lineHeight: 1.75, fontSize: "0.9rem" }}>
              Purpose-built estimating that works the way your shop works. Not enterprise ERP complexity.
            </p>
          </div>
          ...
          <div className="landing-features-grid">
            {[
              ...
              <div
                ...
                style={{ background: "#f9fafb", border: "1px solid #e5e7eb", padding: "32px 28px", transition: "border-color 0.15s, box-shadow 0.15s" }}
              >
                <div style={{ color: BLUE, marginBottom: 16 }}>{f.icon}</div>
                <div style={{ fontWeight: 600, color: "#111827", marginBottom: 8, letterSpacing: "-0.01em" }}>{f.title}</div>
      ...
      {/* COST BREAKDOWN */}
      <section className="landing-section-pad" style={{ padding: "72px 3rem", background: "#f9fafb", borderTop: "1px solid #e5e7eb", borderBottom: "1px solid #e5e7eb" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="landing-cost-grid">
            <div>
              <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.22em", color: BLUE, textTransform: "uppercase", marginBottom: 18 }}>COST ENGINE</div>
              <h2 style={{ fontWeight: 800, fontSize: "clamp(1.5rem, 2.5vw, 2.3rem)", letterSpacing: "-0.025em", color: "#111827", marginBottom: 18 }}>
                Every cost. Visible.<br />Every time.
              </h2>
              <p style={{ color: "#6b7280", lineHeight: 1.85, marginBottom: 28, fontSize: "0.9rem" }}>
                Every calculation is transparent — setup, machining, material, risk, and your margin are shown clearly before you commit to a price.
              </p>
      ...
      {/* PRICING */}
      <section className="landing-section-pad" style={{ padding: "88px 3rem", background: "#ffffff" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.22em", color: BLUE, textTransform: "uppercase", marginBottom: 14 }}>PRICING</div>
          <h2 style={{ fontWeight: 800, fontSize: "clamp(1.6rem, 3vw, 2.6rem)", letterSpacing: "-0.025em", color: "#111827", marginBottom: 14 }}>Straightforward. Honest.</h2>
          <p style={{ color: "#6b7280", maxWidth: 400, margin: "0 auto 52px", lineHeight: 1.75, fontSize: "0.875rem" }}>
          ...
          <p style={{ marginTop: 24, fontSize: 12, color: "#9ca3af" }}>No hidden fees. No per-user charges. No ERP complexity.</p>
        </div>
      </section>

      {/* FOOTER */}
      <footer className="landing-section-pad" style={{ borderTop: "1px solid #e5e7eb", padding: "44px 3rem", background: "#f9fafb" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="landing-footer-inner">
            <div>
              <Wordmark />
              <p style={{ marginTop: 10, fontSize: 12, color: "#9ca3af", maxWidth: 220, lineHeight: 1.6 }}>CNC estimating software for small machine shops.</p>
            </div>
          ...
          <div style={{ marginTop: 36, paddingTop: 20, borderTop: "1px solid #e5e7eb", display: "flex", justifyContent: "space-between", fontSize: 11, color: "#9ca3af", flexWrap: "wrap", gap: 8 }}>
    ...
    <div style={{ background: "#ffffff", border: "1px solid #e5e7eb", padding: 28, boxShadow: "0 1px 8px rgba(0,0,0,0.06)" }}>
      ...
      <div style={{ marginTop: 24, paddingTop: 20, borderTop: "1px solid #f3f4f6" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", flexWrap: "wrap", gap: 8 }}>
          ...
          <span style={{ fontWeight: 700, fontFamily: "monospace", fontSize: "1.5rem", color: BLUE }}>
            £22.34<span style={{ fontSize: 13, fontWeight: 400, color: "#9ca3af", marginLeft: 4 }}>per part</span>
          </span>
        </div>
...
function PricingCard({ label, price, period, features, cta, href, featured }: {
  ...
  return (
    <div
      ...
      style={{ background: "#ffffff", border: featured ? `2px solid ${BLUE}` : "1px solid #e5e7eb", padding: "36px 32px", boxShadow: featured ? "0 4px 24px rgba(29,143,255,0.12)" : "0 1px 8px rgba(0,0,0,0.04)" }}
    >
      {featured && (
      ...
      <div style={{ fontSize: 9, fontWeight: 700, letterSpacing: "0.2em", color: featured ? BLUE : "#9ca3af", textTransform: "uppercase", marginBottom: 18 }}>{label}</div>
      <div style={{ marginBottom: 4 }}>
        <span style={{ fontWeight: 800, fontSize: "2.4rem", color: "#111827", letterSpacing: "-0.03em" }}>{price}</span>
      </div>
      <div style={{ fontSize: 13, color: "#9ca3af", marginBottom: 28 }}>{period}</div>
      <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 32 }}>
        {features.map(f => (
          <div key={f} style={{ fontSize: 13, color: "#374151", display: "flex", alignItems: "center", gap: 8 }}>
      ...
      <Link href={href}>
        <button
          style={featured ? {
            width: "100%", padding: "14px 0", fontSize: 13, fontWeight: 700, letterSpacing: "0.09em", textTransform: "uppercase",
            background: BLUE, color: "#fff", border: "none", cursor: "pointer", transition: "background 0.15s", minHeight: 48,
          } : {
            width: "100%", padding: "14px 0", fontSize: 13, fontWeight: 500, letterSpacing: "0.09em", textTransform: "uppercase",
            background: "transparent", color: "#6b7280", border: "1px solid #d1d5db", cursor: "pointer", transition: "border-color 0.15s", minHeight: 48,
          }}
        >
          {cta}
        </button>
...
function ChipIcon()   { return <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><rect x="7" y="7" width="10" height="10" rx="1"/><line x1="9" y1="3" x2="9" y2="7"/><line x1="15" y1="3" x2="15" y2="7"/><line x1="9" y1="17" x2="9" y2="21"/><line x1="15" y1="17" x2="15" y2="21"/><line x1="3" y1="9" x2="7" y2="9"/><line x1="3" y1="15" x2="7" y2="15"/><line x1="17" y1="9" x2="21" y2="9"/><line x1="17" y1="15" x2="21" y2="15"/></svg>; }
...
function SpeedIcon()  { return <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 15 15"/></svg>; }
